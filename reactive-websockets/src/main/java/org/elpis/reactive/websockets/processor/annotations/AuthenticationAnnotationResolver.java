...
public final class AuthenticationAnnotationResolver extends SocketApiAnnotationResolver<SocketAuthentication> {
    ...
    public CodeBlock resolve(final VariableElement parameter) {
        ...
        final SocketAuthentication annotation = parameter.getAnnotation(this.getAnnotationType());
...
//        }
    ...
    @Override
    Class<SocketAuthentication> getAnnotationType() {
