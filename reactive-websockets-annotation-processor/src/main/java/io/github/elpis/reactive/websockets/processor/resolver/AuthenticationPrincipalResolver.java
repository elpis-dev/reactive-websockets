...
public final class AuthenticationPrincipalResolver
    extends SocketApiAnnotationResolver<AuthenticationPrincipal> {
  private static final String CODE_FOR_PRINCIPAL =
      "final $T $L = context.getPrincipal($S, $L, $T.class);\n";
  ...
  public CodeBlock resolve(final VariableElement parameter) {
    ...
    final TypeName parameterTypeValue =
        this.getTypes()
                .isSameType(
