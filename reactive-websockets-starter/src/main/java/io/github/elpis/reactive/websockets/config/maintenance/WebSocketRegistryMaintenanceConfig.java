package io.github.elpis.reactive.websockets.config.maintenance;
...
public class WebSocketRegistryMaintenanceConfig {
   ...
   * </pre>
   */
  // TODO: Extract cleanupOrphanedSessions from WebSocketSessionRegistry to a separate service class
  // and call it here.
  @Scheduled(
