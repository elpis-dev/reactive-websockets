...
/**
 * Abstract implementation of {@link WebSocketEventManager} that uses {@code
 ...
 * @since 1.0.0
 */
public abstract class MulticastEventManager<T extends WebSocketEvent<?>>
    implements WebSocketEventManager<T> {
