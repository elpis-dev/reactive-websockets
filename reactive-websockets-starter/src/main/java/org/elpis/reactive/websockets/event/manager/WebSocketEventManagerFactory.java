...
public class WebSocketEventManagerFactory {
    private final Map<Class<? extends WebSocketEvent<?>>, WebSocketEventManager<?>> socketEventManagers =
    ...
    public <T extends WebSocketEvent<?>> WebSocketEventManager<T> getEventManager(final Class<T> eventType) {
    ...
    public static class Builder {
        ...
        public <T extends WebSocketEvent<?>> Builder register(final Class<T> eventType,
                                                              final WebSocketEventManager<T> eventManager) {
