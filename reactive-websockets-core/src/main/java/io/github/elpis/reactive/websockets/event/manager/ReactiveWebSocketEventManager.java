 ...
 * @since 1.0.0
 */
public interface ReactiveWebSocketEventManager<T extends WebSocketEvent<?>> {
   ...
   * @return {@link Sinks.EmitResult} - result code signaling about success/failure of sending an
   *     event
   * @since 1.0.0
   */
