...
public class HeaderSocketResource {
    ...
    @OnMessage(value = "/single/get/header", mode = Mode.BROADCAST)
    ...
    @OnMessage(value = "/multiple/get/header", mode = Mode.BROADCAST)
    ...
    @OnMessage(value = "/http", mode = Mode.BROADCAST)
    ...
    @OnMessage(value = "/multimap", mode = Mode.BROADCAST)
