...
@Import({
  WebFilterAuthenticationSocketTest.WebFilterAuthorizationTestSecurityConfiguration.class,
          ...
          (exchange, chain) ->
              ReactiveSecurityContextHolder.getContext()
                  .switchIfEmpty(
                      Mono.defer(
                          () -> {
                            final AnonymousAuthenticationToken authentication =
                                new AnonymousAuthenticationToken(
                                    TestConstants.TEST_VALUE,
                                    new TestPrincipal(),
