package io.github.elpis.reactive.websockets.functional.connection;
...
@Import({BaseWebSocketTest.PermitAllSecurityConfiguration.class, HeartbeatResource.class})
