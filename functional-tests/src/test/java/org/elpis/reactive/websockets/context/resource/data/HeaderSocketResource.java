...
@SocketController("/header")
public class HeaderSocketResource {

    @SocketMapping(value = "/single/get/header", mode = Mode.SHARED)
    ...
    @SocketMapping(value = "/multiple/get/header", mode = Mode.SHARED)
    ...
    @SocketMapping(value = "/http", mode = Mode.SHARED)
    ...
    @SocketMapping(value = "/multimap", mode = Mode.SHARED)
