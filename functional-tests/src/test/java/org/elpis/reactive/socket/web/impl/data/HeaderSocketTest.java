...
import org.elpis.reactive.socket.web.context.resource.data.HeaderSocketResource;
...
public class HeaderSocketTest extends BaseWebSocketTest {
    ...
    @Test
    public void getHttpHeadersTest() throws Exception {
        //given
        final String data = this.randomTextString(5);
        final HttpHeaders headers = new HttpHeaders();
        headers.add("id", data);
    ...
    @Test
    public void getMultiMapTest() throws Exception {
        //given
        final String data = this.randomTextString(5);
        final HttpHeaders headers = new HttpHeaders();
        headers.add("id", data);
    ...
    @Test
    public void getWithMultipleStringHeaderTest() throws Exception {
        //given
